...
output_log = 'output/intercloud_Avg_Data_Transfer_Mar_19_2022.csv'
...
for i in range(episodes):
    ...
    decisionTreeHashTableName = "input/D_Tree_HashFiles/InterCloud/InterCloud_Updated_HTML_Hash_File.csv"
   ...
   #############################
    ...
    cmd = cmd_prefix + ' ' + \
          ...
          totalNumLogicalCores + ' ' + \
          governor
    print('Start transfer: Test Energy,  Iteration: ' + ", Dataset = " + dataset)
    subprocess.run(cmd, shell=True)
    print('Finished transfer of: Test  Energy,  Iteration: ' + ", Dataset = " + dataset)
    time.sleep(10)
    ...
    decisionTreeHashTableName = "input/D_Tree_HashFiles/InterCloud/InterCloud_Updated_Image_Hash_File.csv"
    decisionTreeHashTableSize = '120'
    totalNumPhysicalCores = '10'
    totalNumLogicalCores = '20'
    governor = 'userspace'
