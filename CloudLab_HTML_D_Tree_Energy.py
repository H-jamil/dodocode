...
#
			...
			# 0. Testbed: name of testbed either Chameleon or CloudLab
		 	...
		 	# *****************************************************************************
		 	# PARAMETERS SPECIFIC TO TEST DECISION TREE (13 - 20)
		 	# 13. Initial Alg Interval - 1st alg interval (sampling) in seconds. Used for initial parameters
...
for i in range(2):
    ...
    server_ip = '128.105.145.219'
    bandwidth = '1000'  # Mbps
    rtt = '36'  # ms
    tcp_buf = '4.5'  # MB
    max_channels = '32'
    alg_interval = '30'  # Seconds
    output_log = 'output/CloudLab_D_Tree_Avg_Data_Transfer_Mar_10_2022.csv'
    init_alg_interval = '10'  # Seconds
    inst_d_tree_output_log = '/mnt/ramdisk/decisionTree_cloudlab_InstLog.csv'
    decisionTreeHashTableName = "input/D_Tree_HashFiles/CloudLab/CloudLab_HTML_D_Tree_Hash_File_Energy.csv"
    ...
    # max_channels = '32'
    # alg_interval = '30'  # Seconds
    # output_log = 'output/Luigi_EEMT_Transfer_Mar_10_2022.csv'
    # #############################
    # numCores = '10'
    # numActiveCores = '10'
    # hyperThreading = 'true'
