...
for i in range(3):
    ...
    output_log = 'output/InterCloud_D_Tree_Avg_Data_Transfer_Nov_13_2021.csv'
...
########################
    ...
    init_alg_interval = '10'  # Seconds
    inst_d_tree_output_log = '/mnt/ramdisk/decisionTree_cloudlab_InstLog.csv'
    decisionTreeHashTableName = "input/D_Tree_HashFiles/InterCloud/InterCloud_Video_D_Tree_Hash_File.csv"
    decisionTreeHashTableSize = '120'
    totalNumPhysicalCores = '16'
    totalNumLogicalCores = '32'
    governor = 'userspace'
