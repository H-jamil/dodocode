...
output_log = 'output/intercloud_D_Tree_Avg_Data_Transfer_Mar_28_Jacob_2022.csv'
server_ip = '192.5.86.171'
episodes = 3
chameleon_hash_file_html ="input/D_Tree_HashFiles/InterCloud/InterCloud_HTML_D_Tree_Hash_File_Energy.csv"
chameleon_hash_file_image ="input/D_Tree_HashFiles/InterCloud/InterCloud_Image_D_Tree_Hash_File_Energy.csv"
chameleon_hash_file_video ="input/D_Tree_HashFiles/InterCloud/InterCloud_Video_D_Tree_Hash_File_Energy.csv"
...
for i in range(episodes):
    ...
    inst_d_tree_output_log = '/mnt/ramdisk/decisionTree_intercloud_InstLog.csv'
    decisionTreeHashTableName = "input/D_Tree_HashFiles/InterCloud/InterCloud_HTML_D_Tree_Hash_File.csv"
    ...
    cmd = cmd_prefix + ' ' + \
          ...
          governor
    print('Start transfer: Test intercloud,  Iteration: ' + ", Dataset = " + dataset)
    subprocess.run(cmd, shell=True)
    print('Finished transfer of: Test intercloud,  Iteration: ' + ", Dataset = " + dataset)
    time.sleep(10)
   ...
   #############################
    ...
    init_alg_interval = '10'  # Seconds
    inst_d_tree_output_log = '/mnt/ramdisk/decisionTree_intercloud_InstLog_energy.csv'
    ...
    cmd = cmd_prefix + ' ' + \
          ...
          totalNumLogicalCores + ' ' + \
          governor
    print('Start transfer: Test intercloud Energy,  Iteration: ' + ", Dataset = " + dataset)
    subprocess.run(cmd, shell=True)
    print('Finished transfer of: Test intercloud Energy,  Iteration: ' + ", Dataset = " + dataset)
    time.sleep(10)
...
#    server_ip = '128.105.145.238'
    ...
    init_alg_interval = '10'  # Seconds
    inst_d_tree_output_log = '/mnt/ramdisk/decisionTree_intercloud_InstLog.csv'
    decisionTreeHashTableName = "input/D_Tree_HashFiles/InterCloud/InterCloud_Image_D_Tree_Hash_File.csv"
    decisionTreeHashTableSize = '120'
    totalNumPhysicalCores = '10'
    totalNumLogicalCores = '20'
    governor = 'userspace'
    ...
    cmd = cmd_prefix + ' ' + \
          ...
          totalNumLogicalCores + ' ' + \
          governor
    print('Start transfer: Test intercloud Decision Tree,  Iteration: ' + ", Dataset = " + dataset)
    subprocess.run(cmd, shell=True)
    print('Finished transfer of: Test intercloud Decision Tree,  Iteration: ' + ", Dataset = " + dataset)
    time.sleep(10)
    ...
    cmd = cmd_prefix + ' ' + \
          ...
          totalNumLogicalCores + ' ' + \
          governor
    print('Start transfer: Test intercloud Decision Tree Energy,  Iteration: ' + ", Dataset = " + dataset)
    subprocess.run(cmd, shell=True)
    print('Finished transfer of: Test intercloud Decision Tree Energy,  Iteration: ' + ", Dataset = " + dataset)
    time.sleep(10)
