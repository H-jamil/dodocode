...
/**
 * Created by lrodolph on 7/20/20.
 */

public class EnergyParameterObject {
    public int cc_level;
    public int pp_level;
    public int coreNum;
    public int freq;
    ...
    public EnergyParameterObject(int cc_level, int pp_level, int coreNum, int freq ){
    ...
    public EnergyParameterObject(int cc_level, int pp_level, int coreNum, int freq, double min_throughput, double max_throughput, double min_conf_tPut, double max_conf_tPut ){
        this.cc_level = cc_level;
        this.pp_level = pp_level;
        this.coreNum = coreNum;
        this.freq = freq;
        ...
        this.min_conf_energy = min_conf_tPut;
        this.max_conf_energy = max_conf_tPut;
    }
